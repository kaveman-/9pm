...
struct	Subfont
{
	...
	Bitmap	*bits;		/* bitmap of characters */
	ulong	qid;		/* unique id */
};
...
struct Font
{
	...
	char		ascent;	/* top of bitmap to baseline */
	short		nmap;	/* number of subfonts */
	Fontmap**	map;	/* as read from file */
};
...
extern double	 bloadbandwidth();
extern void	 bclose(void);
extern void	 berror(char*);
extern void	 bbound(Bitmap*, Rectangle);
extern void	 bshow(Bitmap*, Rectangle);
extern void	 bshade(Rectangle);
extern void	 bload(Bitmap *i, Rectangle r, uchar *data);
extern void	 bitblt(Bitmap*, Point, Bitmap*, Rectangle, Fcode);
extern int	 bltclip(Bitmap*, Point*, Bitmap*, Rectangle*);
extern Font*	 rdfontfile(char*);
extern int	 fminldepth(Font*);
...
extern int	 linesize(Bitmap*, Rectangle);
...
extern ulong	 event(GEvent*);
extern ulong	 eread(ulong, GEvent*);
...
extern	Font	*font;
extern	Qlock	libglock;

/* use lots of files */
extern	int	_bitbltfd;
extern	int	_refreshfd;
extern	int	_graphicsctlfd;
extern	int	_mousefd;
